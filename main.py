...
if __name__ == "__main__":
    ...
    finetuner.load_checkpoint(checkpoint_path=args.checkpoint_path if args.checkpoint_path else os.path.join(current_checkpoint_dir, 'checkpoint_epoch_500.pth'))
